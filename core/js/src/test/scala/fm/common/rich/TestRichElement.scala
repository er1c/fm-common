...
final class TestRichElement extends AnyFunSuite with Matchers with BeforeAndAfterAll {
  ...
  // With Selector
  private def closestWithAncestorChildrenTest[T <: Element: ClassTag](
    fromElementID: String,
    selector: String,
    expectedID: String)(implicit ev: ElementType[T]): Unit = {
  ...
  // Without Selector
  private def closestWithAncestorChildrenTest[T <: Element: ClassTag](fromElementID: String, expectedID: String)(
    implicit ev: ElementType[T]): Unit = {
    val element: Element = document.getElementById(fromElementID)
  ...
  test("closestWithAncestorChildren - finding the nearest input") {
    ...
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-in-body-trigger-element",
      "input",
      "closest-in-body-target-two")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-in-body-trigger-element",
      "input[class='target-one']",
      "closest-in-body-target-one")

    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-sibling-trigger-element",
      "closest-sibling-closest-target-two")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-sibling-trigger-element",
      "input",
      "closest-sibling-closest-target-two")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-sibling-trigger-element",
      "input[class='target-one']",
      "closest-sibling-closest-target-one")

    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-child-of-ancestor-trigger-element",
      "closest-is-child-of-ancestor-target-two")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-child-of-ancestor-trigger-element",
      "input",
      "closest-is-child-of-ancestor-target-two")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-child-of-ancestor-trigger-element",
      "input[class='target-one']",
      "closest-is-child-of-ancestor-target-one")

    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-deep-child-of-ancestor-trigger-element",
      "closest-is-deep-child-of-ancestor-target-three")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-deep-child-of-ancestor-trigger-element",
      "input",
      "closest-is-deep-child-of-ancestor-target-three")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-deep-child-of-ancestor-trigger-element",
      "input[class='target-one']",
      "closest-is-deep-child-of-ancestor-target-one")
    closestWithAncestorChildrenTest[HTMLInputElement](
      "closest-is-deep-child-of-ancestor-trigger-element",
      "input[class='target-two']",
      "closest-is-deep-child-of-ancestor-target-two")

    closestWithAncestorChildrenTest[HTMLDivElement](
      "nested-div-inside-one",
      "div[class='nested-div']",
      "nested-div-outside")
    closestWithAncestorChildrenTest[HTMLDivElement](
      "nested-div-inside-one-child-two-grandchild-two",
      "div[class='nested-div']",
      "nested-div-inside-one-child-one-grandchild-one")
    closestWithAncestorChildrenTest[HTMLDivElement](
      "nested-div-inside-one-child-three",
      "div[class='nested-div']",
      "nested-div-inside-one-child-two-grandchild-two")
  }
