...
object Base16 extends BaseEncoding {
  ...
  def decode(data: Array[Char]): Array[Byte] =
    try { if (isLower(data)) base16Lower.decode(data) else base16Upper.decode(data) }
...
object Base32 extends BaseEncoding {
  ...
  def decode(data: Array[Char]): Array[Byte] =
    try { if (isLower(data)) base32Lower.decode(data) else base32Upper.decode(data) }
    catch exceptionHandler
  def decode(data: CharSequence): Array[Byte] =
    try { if (isLower(data)) base32Lower.decode(data) else base32Upper.decode(data) }
    catch exceptionHandler
  ...
  def encodeNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    base32LowerNoPadding.encode(bytes, offset, length)
  ...
  def encodeUpperNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    base32UpperNoPadding.encode(bytes, offset, length)
}
...
object Base64 extends BaseEncoding {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  val NO_OPTIONS: Int = 0
  val URL_SAFE: Int = 16

  def encodeBytes(bytes: Array[Byte]): String = encode(bytes)
  def encodeBytes(bytes: Array[Byte], options: Int): String =
    if (options === URL_SAFE) encodeURL(bytes) else encode(bytes)
  def decode(data: CharSequence, options: Int): Array[Byte] =
    if (options === URL_SAFE) Base64URL.decode(data) else decode(data)
  def decode(data: Array[Byte]): Array[Byte] = decode(new String(data, UTF_8))
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // END - Compatibility with old Base64 Java Class
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  final class InputStream(is: java.io.InputStream)
    extends FilterInputStream(java.util.Base64.getDecoder().wrap(new URLToStrictInputStream(is)))
  ...
  def encodeNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    Base64Strict.encodeNoPadding(bytes, offset, length)
  ...
  def encodeURLNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    Base64URL.encodeNoPadding(bytes, offset, length)
...
object Base64Strict extends BaseEncoding {
  ...
  def encodeNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    base64NoPadding.encode(bytes, offset, length)
...
object Base64URL extends BaseEncoding {
  ...
  def encodeNoPadding(bytes: Array[Byte], offset: Int, length: Int): String =
    base64UrlNoPadding.encode(bytes, offset, length)

  final class InputStream(is: java.io.InputStream) extends FilterInputStream(java.util.Base64.getUrlDecoder().wrap(is))
  final class OutputStream(os: java.io.OutputStream)
    extends FilterOutputStream(java.util.Base64.getUrlEncoder().wrap(os))
}

object BaseEncoding {
  final class DecodingException(msg: String, cause: Throwable, stackTrace: Array[StackTraceElement])
  ...
  private val exceptionHandler: PartialFunction[Throwable, Nothing] = {
    case ex: GuavaBaseEncoding.DecodingException =>
      throw new DecodingException(ex.getMessage, ex.getCause, ex.getStackTrace)
