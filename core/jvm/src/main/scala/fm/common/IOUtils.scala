...
object IOUtils {
  ...
  def detectCharset(is: InputStream, useMarkReset: Boolean): Option[Charset] =
    detectCharsetName(is, useMarkReset).map { CharsetUtil.forName }
  ...
  def detectUniversalCharset(is: InputStream, useMarkReset: Boolean): Option[Charset] =
    detectUniversalCharsetName(is, useMarkReset).map { CharsetUtil.forName }
  ...
  def detectUniversalCharsetName(is: InputStream, useMarkReset: Boolean): Option[String] = {
    if (useMarkReset)
      require(is.markSupported, "detectCharsetName required mark/reset support!  Try wrapping in a BufferedInputStream")
