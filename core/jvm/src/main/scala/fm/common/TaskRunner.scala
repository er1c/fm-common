...
final class TaskRunner(
  ...
  val maxThreads: Int,
  val queueSize: Int,
  val blockOnFullQueue: Boolean = true)
  ...
  protected val executor: ThreadPoolExecutor = {
    val rejectedHandler: RejectedExecutionHandler =
      if (blockOnFullQueue) new BlockRejectExecutionHandler() else new StandardRejectExecutionHandler()
