...
final class TestBase32Hex extends AnyFunSuite with Matchers {
  private[this] val data: Vector[(String, String)] = Vector(
    ...
    new String(
      ...
      UTF_8) -> "000g40o40k30e209185go38e1s8124gj2gahc5oo34d1m70t3ofi08924ci2a9h750kikapc5kn2uc1h68pj8d9m6ss3iehr7gujsfq085146h258p3kgiaa9d64qjifa18l4kqkalb5em2pb9dlonaubtg62oj3chimcpr8d5l6mr3ddpnn0sbiedq7atjnf1snkursflv7u==="
  )
