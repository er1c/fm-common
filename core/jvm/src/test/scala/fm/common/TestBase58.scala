...
final class TestBase58 extends AnyFunSuite with Matchers {
  ...
  private[this] val data: Vector[(Array[Byte], String)] = Vector(
    ...
    (
      Array[Byte](0x73, 0x69, 0x6d, 0x70, 0x6c, 0x79, 0x20, 0x61, 0x20, 0x6c, 0x6f, 0x6e, 0x67, 0x20, 0x73, 0x74, 0x72,
        0x69, 0x6e, 0x67),
      "2cFupjhnEsSn59qHXstmK2ffpLv2"),
    (
      Array[Byte](0x00, 0xeb, 0x15, 0x23, 0x1d, 0xfc, 0xeb, 0x60, 0x92, 0x58, 0x86, 0xb6, 0x7d, 0x06, 0x52, 0x99, 0x92,
    ...
    (
      Array(0, 1, 9, 102, 119, 96, 6, -107, 61, 85, 103, 67, -98, 94, 57, -8, 106, 13, 39, 59, -18, -42, 25, 103, -10),
      "16UwLL9Risc3QfPqBUvKofHmBQ7wMtjvM"),
    ("abcdefghijklmnopqrstuvwxyz", "3yxU3u1igY8WkgtjK92fbJQCd4BZiiT1v25f"),
    (
      "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz",
      "QNoRV1sxwosKt47hNWXhBXyUVZxxn47YeXdAG7cLaAuKKaMzmF2NCzpV2Tz6mBSvvnHZ5PF"),
    (
      """abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%^&*()_+-=><,./';":][}{\|""",
      "2ANFG5vFY32kSKHtuXNf5yqv3phrEExWbRXtZRMbrdtpKuR39uZvwgFaSz7RsJBqx1b36CsqtQLy8zcf5JBzXckGnNf7KBEJtn5akLMzmiFEKGck5t31n2LAkwk2w"),
    (
      new String((0 to 127).map { _.toByte }.toArray, UTF_8),
      "12Mc55eJJSx97JNqXmW7TuJSoE9N3JhfHo9hbKS9Pm2qUNVUH1Tgd6xAdqeP8xAxDhjuR6vmAu7KR9Kt2PqaMEEcD2ThugBHeVLCJtW1V1iMZ13ZJfDH7h8E11Xz9hpEDcPUikMCe5p9EHLv7Y3wNXT2bBNYZarpY7Trn3cm8vvo7t"),
