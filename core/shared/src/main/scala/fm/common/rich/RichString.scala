...
final class RichString(val s: String) extends AnyVal {
  ...
  def toBooleanOptionCached: Option[Boolean] =
    try { OptionCache.valueOf(java.lang.Boolean.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toByteOptionCached: Option[Byte] =
    try { OptionCache.valueOf(java.lang.Byte.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toShortOptionCached: Option[Short] =
    try { OptionCache.valueOf(java.lang.Short.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toIntOptionCached: Option[Int] =
    try { OptionCache.valueOf(java.lang.Integer.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toLongOptionCached: Option[Long] =
    try { OptionCache.valueOf(java.lang.Long.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toFloatOptionCached: Option[Float] =
    try { Some(java.lang.Float.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  def toDoubleOptionCached: Option[Double] =
    try { Some(java.lang.Double.valueOf(s)) }
    catch { case _: NumberFormatException => None }
  ...
  def toBigDecimal: BigDecimal =
    toBigDecimalOption.getOrElse {
      throw new NumberFormatException(s"RichString.toBigDecimal parsing error for value: $s")
    }
  ...
  def toBigInteger: BigInteger =
    toBigIntegerOption.getOrElse {
      throw new NumberFormatException(s"RichString.toBigInteger parsing error on value: $s")
    }
