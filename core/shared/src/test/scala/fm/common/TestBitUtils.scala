...
final class TestBitUtils extends AnyFunSuite with Matchers {
  ...
  private def checkLong(a: Int, b: Int, res: Long): Unit =
  ...
  private def checkInt(a: Short, b: Short, res: Int): Unit =
    TestHelpers.withCallerInfo {
  ...
  private def checkIntWithUpper24Bits(a: Int, b: Short, res: Int): Unit =
    TestHelpers.withCallerInfo {
  ...
  private def checkIntWithLower24Bits(a: Short, b: Int, res: Int): Unit =
    TestHelpers.withCallerInfo {
