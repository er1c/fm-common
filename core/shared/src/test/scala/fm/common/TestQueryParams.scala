...
final class TestQueryParams extends AnyFunSuite with Matchers {
  ...
  test("URL") {
    val url: URL = URL(
      "http://www.gopjn.com/t/1-1539-47154-1539?url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058")
    QueryParams(
      url).toString shouldBe "url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058"
    url.query.get should equal(
      "url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058")
    url.updateQueryParam("url", "foo & bar").query.get should equal("url=foo+%26+bar")
    url.updateQueryParam("url", " Hello & World! ").toString should equal(
      "http://www.gopjn.com/t/1-1539-47154-1539?url=+Hello+%26+World%21+")
  }
  ...
  test("URI") {
    val uri: URI = URI(
      "http://www.gopjn.com/t/1-1539-47154-1539?url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058")
    QueryParams(
      uri).toString shouldBe "url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058"
    uri.query.get should equal(
      "url=http%3A%2F%2Fwww.trailerhitches.com%2Fcarriers%2Fcargo-carriers%2Fthulesportrackfrontierroofracka21003s.cfm%3FTID%3DTGP058")
    uri.updateQueryParam("url", "foo & bar").query.get should equal("url=foo+%26+bar")
    uri.updateQueryParam("url", " Hello & World! ").toString should equal(
      "http://www.gopjn.com/t/1-1539-47154-1539?url=+Hello+%26+World%21+")
  }
